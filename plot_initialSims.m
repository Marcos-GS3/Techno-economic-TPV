...
fname = sprintf('sim0_CF%d_CPA%d_LCOH%d_%s_Tem%d.mat', CF*100, round(CPA_tpv), round(LCOH*100), cellType, Tem);
load(fname)
plot(Ttpv, PayBack(:,1), '-o', 'Color', orange1, 'MarkerFaceColor', orange1,'MarkerSize', 5, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=0 €/MWh'); % Custom yellow with filled circle markers
plot(Ttpv, PayBack(:,2), '-x', 'Color', orange1, 'MarkerFaceColor', orange1,'MarkerSize', 7, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=25 €/MWh');         % Custom red with filled circle markers
plot(Ttpv, PayBack(:,3), '-^', 'Color', orange1, 'MarkerFaceColor', orange1,'MarkerSize', 5, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=50 €/MWh'); % Custom yellow with filled circle markers
% CPA_tpv = 70 €/cm2
CPA_tpv = CPA_tpv_var(2);
fname = sprintf('sim0_CF%d_CPA%d_LCOH%d_%s_Tem%d.mat', CF*100, round(CPA_tpv), round(LCOH*100), cellType, Tem);
load(fname)
...
fname = sprintf('sim0_CF%d_CPA%d_LCOH%d_%s_Tem%d.mat', CF*100, round(CPA_tpv), round(LCOH*100), cellType, Tem);
load(fname)
plot(Ttpv, PayBack(:,1), '-o', 'Color', orange2, 'MarkerFaceColor', orange2,'MarkerSize', 5, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=0 €/MWh'); % Custom yellow with filled circle markers
plot(Ttpv, PayBack(:,2), '-x', 'Color', orange2, 'MarkerFaceColor', orange2,'MarkerSize', 7, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=25 €/MWh');         % Custom red with filled circle markers
plot(Ttpv, PayBack(:,3), '-^', 'Color', orange2, 'MarkerFaceColor', orange2,'MarkerSize', 5, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=50 €/MWh'); % Custom yellow with filled circle markers
% CPA_tpv = 70 €/cm2
CPA_tpv = CPA_tpv_var(2);
fname = sprintf('sim0_CF%d_CPA%d_LCOH%d_%s_Tem%d.mat', CF*100, round(CPA_tpv), round(LCOH*100), cellType, Tem);
load(fname)
...
fname = sprintf('sim0_CF%d_CPA%d_LCOH%d_%s_Tem%d.mat', CF*100, round(CPA_tpv), round(LCOH*100), cellType, Tem);
load(fname)
plot(Ttpv, PayBack(:,1), '-o', 'Color', orange3, 'MarkerFaceColor', orange3,'MarkerSize', 5, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=0 €/MWh'); % Custom yellow with filled circle markers
plot(Ttpv, PayBack(:,2), '-x', 'Color', orange3, 'MarkerFaceColor', orange3,'MarkerSize', 7, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=25 €/MWh');         % Custom red with filled circle markers
plot(Ttpv, PayBack(:,3), '-^', 'Color', orange3, 'MarkerFaceColor', orange3,'MarkerSize', 5, 'LineWidth', 1.5, 'DisplayName', 'LCOrH=50 €/MWh'); % Custom yellow with filled circle markers
% CPA_tpv = 70 €/cm2
CPA_tpv = CPA_tpv_var(2);
fname = sprintf('sim0_CF%d_CPA%d_LCOH%d_%s_Tem%d.mat', CF*100, round(CPA_tpv), round(LCOH*100), cellType, Tem);
load(fname)
